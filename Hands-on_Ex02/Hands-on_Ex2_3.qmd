...
It can be broken down into the following steps: - Deriving spatial weight matrix - Computing Gi statistics - Mapping Gi statistics
...
-   <div>
    ...
    -   changes bandwidth based on density
...
Here we will be using fixed distance for calculating Gi statistics. The results is set as a Z-score. - Positive Z-score refers to high clusters - Negative Z-score refers to low clusters
