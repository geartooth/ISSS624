...
# Spatial Correlogram Here we examine the patterns of the Moran's I and Geary's C test as seen in Hands-on Ex 2 part 2.

# Moran's I correlogram We will use the *sp.correlogram()* for calculating the spatial correlogram of the devleopment of Hunan.
...
# Geary's C correlogram We will use the *sp.correlogram()* for calculating the spatial correlogram of the devleopment of Hunan.
