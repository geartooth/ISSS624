...
We will then compile all of the outliers and clusters from the different time intervals together for easier comparison. We will be using the highest ridership volume for high-low and high-high hexagons and lowest ridership volume for low-high and low-low hexagons.
