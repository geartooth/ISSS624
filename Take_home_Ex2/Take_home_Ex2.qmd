...
As we can see, the number of trips can be too messy and we can make it clearer by limiting the plot to only a certain number of trips.
...
Here we will begin our actual modelling
